          ...
          <div className="p-6">
            <div
              className={[
                ...
                tutorialOpen && tutorialSteps[tutorialStep]?.target === 'nav' ? 'ring-2 ring-slate-900 ring-offset-2 ring-offset-slate-50 rounded-xl p-2 -m-2' : '',
              ].join(' ')}
            >
          ...
          <div className="absolute inset-0 p-4 flex items-end sm:items-center sm:justify-center">
            <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white shadow-xl">
              <div className="p-5 space-y-3">
                <div className="text-sm font-semibold text-slate-900">{tutorialSteps[tutorialStep]?.title ?? 'Tutorial'}</div>
                <div className="text-sm text-slate-600">{tutorialSteps[tutorialStep]?.body ?? ''}</div>

                <div className="flex items-center justify-between gap-2 pt-2">
                  <Button variant="secondary" onClick={closeTutorial}>
                    Pular
                  </Button>
                  <div className="flex items-center gap-2">
                    <Button
